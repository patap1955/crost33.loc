...
@section("css")
    ...
    <link rel="stylesheet" href="{{ asset("adminlte/dist/css/component/gallery.css") }}">
@endsection
...
@section("scripts")
    ...
    <script src="{{ asset("adminlte/dist/js/components/formGallery.js") }}"></script>
    <script src="{{ asset("adminlte/dist/js/components/addFoto.js") }}"></script>
